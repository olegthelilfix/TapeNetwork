...
const published: Field = { name: "published", label: "Published", type: "boolean", inList: true };
const sort: Field = { name: "sort", label: "Sort", type: "number" };
...
export const resourceDefs: ResourceDef[] = [
  {
    ...
    fields: [
      ...
      { name: "scheduleSlot", label: "Schedule slot", type: "text", inList: true },
      { name: "episodesCount", label: "Episodes count", type: "number" },
      { name: "hoursPerWeek", label: "Hours / week", type: "text" },
      { name: "monthlyViews", label: "Monthly views", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "slug", label: "Slug", type: "text", required: true, inList: true },
      { name: "epNo", label: "Episode no.", type: "text", inList: true },
      { name: "description", label: "Description", type: "textarea" },
      ...
      { name: "thumbMediaId", label: "Thumbnail", type: "media" },
      { name: "live", label: "Live", type: "boolean", inList: true },
  ...
  },
  {
    ...
    fields: [
      { name: "showId", label: "Show", type: "reference", refResource: "shows", optionLabel: "name", required: true },
      { name: "name", label: "Name", type: "text", required: true, inList: true },
      { name: "initials", label: "Initials", type: "text", inList: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "dek", label: "Dek", type: "textarea" },
      { name: "body", label: "Body (paragraphs)", type: "stringArray" },
      { name: "readMinutes", label: "Read minutes", type: "number" },
      { name: "heroMediaId", label: "Hero image", type: "media" },
      { name: "publishedAt", label: "Published at", type: "datetime" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "showId", label: "Show", type: "reference", refResource: "shows", optionLabel: "name" },
      { name: "hostsLabel", label: "Hosts label", type: "text", inList: true },
      { name: "dayOfWeek", label: "Day of week (0-6)", type: "number" },
      { name: "live", label: "Live", type: "boolean", inList: true },
      sort,
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "price", label: "Price", type: "text", required: true, inList: true },
  ...
  },
  {
    ...
    label: "Home layout",
    fields: [
      { name: "type", label: "Block", type: "select", required: true, inList: true, options: [
        { label: "Featured", value: "featured" },
        { label: "Most watched", value: "most_watched" },
        { label: "Up next", value: "up_next" }] },
      { name: "refType", label: "Ref type", type: "select", inList: true, options: [
        { label: "Episode", value: "episode" },
        { label: "Video", value: "video" },
        { label: "Article", value: "article" }] },
      { name: "refId", label: "Ref id", type: "number", inList: true },
  ...
  },
  {
    ...
    label: "Media",
    fields: [
      { name: "filename", label: "Filename", type: "text", inList: true },
      { name: "url", label: "URL", type: "text", required: true, inList: true },
      { name: "kind", label: "Kind", type: "select", inList: true, options: [
        { label: "Image", value: "image" }, { label: "Video", value: "video" }] },
      { name: "mime", label: "MIME", type: "text" },
...
export const resourceByName = Object.fromEntries(resourceDefs.map((r) => [r.name, r]));
